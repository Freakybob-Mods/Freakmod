...
public class FreakmodModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> FREAKTAB = REGISTRY.register("freaktab",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.freakmod.freaktab")).icon(() -> new ItemStack(FreakmodModItems.FREAKBOB.get())).displayItems((parameters, tabData) -> {
