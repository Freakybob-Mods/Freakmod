...
@Mod("freakmod")
public class FreakmodMod {
	public static final Logger LOGGER = LogManager.getLogger(FreakmodMod.class);
	public static final String MODID = "freakmod";

	public FreakmodMod(IEventBus modEventBus) {
